    ...
    <div className="bg-white border rounded-xl shadow-sm p-4 space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className="w-full p-2 border rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-gray-50"
          placeholder="Add whatever additional notes to help the AI understand how to teach this step better..."
        />
